...
pred NoSharedMem {
	...
	( a.region = Attacker and a.readers = { ________ } and a.writers = { ________ } )
}
...
pred flush_reload {
	...
	____________[f, a'] and
	IsAnyMemory[a] and
	IsAnyRead[a'] and
	NodeExists[a, L1ViCLCreate] and
	___ __________[a', ____________] and 
	CanSourceL1[a, a'] and	
	EdgeExists[a, ____________, f, _______] and
...
pred prime_probe {
	...
	// ____________[a, a'] and		// be sure to uncomment this lines before running prime_probe
	IsAnyMemory[a] and	
	IsAnyRead[a'] and	
	// __________[a, ____________] and	// be sure to uncomment this line before running prime_probe
	NodeExists[a', L1ViCLCreate] and 
        CanSourceL1[a, a'] and
